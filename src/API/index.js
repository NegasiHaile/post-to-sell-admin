...
import { apiGetAllBanners, apiAddNewBanner, apiEditBanner, apiDeleteBanner } from './Banners'; // Banners API
...
export { apiGetAllBanners, apiAddNewBanner, apiEditBanner, apiDeleteBanner }; // Banners
