...
import { apiAddCategory, apiGetAllCategories, apiEditCategoryImage, apiDeleteCategoryDetail } from './Categories'; // categories
...
export { apiAddCategory, apiGetAllCategories, apiEditCategoryImage, apiDeleteCategoryDetail }; // categories
